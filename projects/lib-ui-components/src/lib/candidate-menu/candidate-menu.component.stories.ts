...
const meta: Meta<CandidateMenuComponent> = {
...
export default meta;
type Story = StoryObj<CandidateMenuComponent>;

export const Default: Story = {
  args: {},
};

export const Year2020OneOffice: Story = {
  args: {
    activeItem: {
      officeTitle: 'Mayor',
      districtNumber: '2',
...
export const Year2020TwoOffices: Story = {
  args: {
    detailsActive: true,
    mayor: {
      electionYear: '2020',
...
export const Year2020ThreeOffices: Story = {
  args: {
    activeItem: {
